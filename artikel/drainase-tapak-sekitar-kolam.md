---
article_id: KOL-02-03
title: "Drainase Tapak agar Limpasan Tidak Masuk Kolam"
slug: "drainase-tapak-sekitar-kolam"
...
date_modified: null
parent_topic: KOL-02
primary_intent: "Plan surface-water separation"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/drainase-tapak-sekitar-kolam.html"
...
# Drainase Tapak agar Limpasan Tidak Masuk Kolam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Drainase Tapak agar Limpasan Tidak Masuk Kolam”
...
- **Primary intent:** Plan surface-water separation
...
- **Scope boundary:** Site concept; civil sizing excluded
- **Final public route:** `/artikel/drainase-tapak-sekitar-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Drainase Tapak agar Limpasan Tidak Masuk Kolam**.
...
- `KOL-02-01` → `/artikel/checklist-survei-tapak-kolam.html` — Checklist Survei Tapak Sebelum Merancang Kolam
- `KOL-02-02` → `/artikel/air-tanah-gaya-apung-kolam.html` — Air Tanah dan Gaya Apung pada Kolam Kosong
- `KOL-02-04` → `/artikel/akses-konstruksi-proyek-kolam.html` — Akses Alat, Material, dan Pembuangan Tanah Galian
...
- **Tie back to this article:** Keep the explanation specific to “Drainase Tapak agar Limpasan Tidak Masuk Kolam”.
