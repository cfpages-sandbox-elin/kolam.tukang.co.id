---
article_id: KOL-13-03
title: "Tekanan Filter Naik atau Flow Turun"
slug: "diagnosis-flow-filter-kolam"
...
date_modified: null
parent_topic: KOL-13
primary_intent: "Triage filtration symptoms"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/diagnosis-flow-filter-kolam.html"
...
# Tekanan Filter Naik atau Flow Turun

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tekanan Filter Naik atau Flow Turun”
...
- **Primary intent:** Triage filtration symptoms
...
- **Scope boundary:** Equipment isolation and competent service
- **Final public route:** `/artikel/diagnosis-flow-filter-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tekanan Filter Naik atau Flow Turun**.
...
- `KOL-13-01` → `/artikel/diagnosis-air-kolam-keruh.html` — Air Keruh: Pohon Keputusan Pemeriksaan Kolam
...
- **Tie back to this article:** Keep the explanation specific to “Tekanan Filter Naik atau Flow Turun”.
