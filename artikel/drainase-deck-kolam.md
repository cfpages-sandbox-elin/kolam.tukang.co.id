---
article_id: KOL-09-04
title: "Drainase Deck agar Air Kotor Tidak Masuk Kolam"
slug: "drainase-deck-kolam"
...
date_modified: null
parent_topic: KOL-09
primary_intent: "Separate runoff"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/drainase-deck-kolam.html"
...
# Drainase Deck agar Air Kotor Tidak Masuk Kolam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Drainase Deck agar Air Kotor Tidak Masuk Kolam”
...
- **Primary intent:** Separate runoff
...
- **Scope boundary:** Civil/hydraulic sizing excluded
- **Final public route:** `/artikel/drainase-deck-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Drainase Deck agar Air Kotor Tidak Masuk Kolam**.
...
- `KOL-09-06` → `/artikel/mockup-finish-kolam.html` — Mockup Warna dan Finish Kolam Sebelum Pemasangan
...
- **Tie back to this article:** Keep the explanation specific to “Drainase Deck agar Air Kotor Tidak Masuk Kolam”.
