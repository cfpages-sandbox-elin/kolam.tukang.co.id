---
article_id: KOL-13-04
title: "Pompa Bising, Bergetar, atau Kehilangan Prime"
slug: "diagnosis-pompa-kolam"
description: "Diagnose water/equipment symptoms and plan condition-based care"
status: outline
publication_date: "2026-06-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KOL-13
primary_intent: "Triage pump symptoms"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/diagnosis-pompa-kolam.html"
...
# Pompa Bising, Bergetar, atau Kehilangan Prime

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pompa Bising, Bergetar, atau Kehilangan Prime”
- **Reader and situation:** Diagnose water/equipment symptoms and plan condition-based care
- **Reader outcome:** Diagnose water/equipment symptoms and plan condition-based care
- **Primary intent:** Triage pump symptoms
...
- **Scope boundary:** No energized equipment repair instruction
- **Final public route:** `/artikel/diagnosis-pompa-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pompa Bising, Bergetar, atau Kehilangan Prime**.
...
- `KOL-13-02` → `/artikel/diagnosis-alga-berulang-kolam.html` — Alga Berulang: Mencari Akar Masalah Sistem
- `KOL-13-03` → `/artikel/diagnosis-flow-filter-kolam.html` — Tekanan Filter Naik atau Flow Turun
- `KOL-13-05` → `/artikel/log-investigasi-kehilangan-air.html` — Kehilangan Air Kolam: Log Observasi Sebelum Uji
- `KOL-13-06` → `/artikel/maintenance-berbasis-kondisi-kolam.html` — Menyusun Jadwal Maintenance Berbasis Kondisi
...
- **Tie back to this article:** Keep the explanation specific to “Pompa Bising, Bergetar, atau Kehilangan Prime”.
