---
article_id: KOL-10-04
title: "Rambu, Penanda Kedalaman, dan Aturan Penggunaan"
slug: "rambu-penanda-kedalaman-kolam"
description: "Plan barriers, entries, visibility, rescue interfaces, signage, and accessibility"
status: outline
publication_date: "2026-04-08"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KOL-10
primary_intent: "Plan user information"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/rambu-penanda-kedalaman-kolam.html"
...
# Rambu, Penanda Kedalaman, dan Aturan Penggunaan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Rambu, Penanda Kedalaman, dan Aturan Penggunaan”
- **Reader and situation:** Plan barriers, entries, visibility, rescue interfaces, signage, and accessibility
- **Reader outcome:** Plan barriers, entries, visibility, rescue interfaces, signage, and accessibility
- **Primary intent:** Plan user information
...
- **Scope boundary:** Wording/placement per owner/regulator
- **Final public route:** `/artikel/rambu-penanda-kedalaman-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Rambu, Penanda Kedalaman, dan Aturan Penggunaan**.
...
- `KOL-10-02` → `/artikel/barrier-gate-akses-kolam.html` — Barrier, Gate, dan Kontrol Akses Area Kolam
- `KOL-10-03` → `/artikel/risiko-suction-entrapment-kolam.html` — Risiko Suction Entrapment pada Sistem Kolam
- `KOL-10-05` → `/artikel/visibilitas-pengawasan-darurat-kolam.html` — Visibilitas Air, Pengawasan, dan Respons Darurat
- `KOL-10-06` → `/artikel/brief-aksesibilitas-kolam.html` — Aksesibilitas Kolam: Input untuk Lift, Ramp, dan Transfer
...
- **Tie back to this article:** Keep the explanation specific to “Rambu, Penanda Kedalaman, dan Aturan Penggunaan”.
