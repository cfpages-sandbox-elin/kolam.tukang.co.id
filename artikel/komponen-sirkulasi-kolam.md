---
article_id: KOL-06-03
title: "Main Drain, Skimmer, Gutter, dan Balance Tank"
slug: "komponen-sirkulasi-kolam"
description: "Define turnover inputs, suction/return layout, pipe routing, and balancing"
status: outline
publication_date: "2025-12-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KOL-06
primary_intent: "Understand suction/collection roles"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/komponen-sirkulasi-kolam.html"
...
# Main Drain, Skimmer, Gutter, dan Balance Tank

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Main Drain, Skimmer, Gutter, dan Balance Tank”
- **Reader and situation:** Define turnover inputs, suction/return layout, pipe routing, and balancing
- **Reader outcome:** Define turnover inputs, suction/return layout, pipe routing, and balancing
- **Primary intent:** Understand suction/collection roles
...
- **Scope boundary:** Safety and sizing gated
- **Final public route:** `/artikel/komponen-sirkulasi-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Main Drain, Skimmer, Gutter, dan Balance Tank**.
...
- `KOL-06-01` → `/artikel/turnover-flow-sirkulasi-kolam.html` — Memahami Turnover, Flow, dan Waktu Sirkulasi Kolam
- `KOL-06-02` → `/artikel/penempatan-inlet-dan-dead-zone.html` — Menempatkan Inlet agar Sirkulasi Tidak Membentuk Dead Zone
- `KOL-06-04` → `/artikel/input-head-loss-pipa-kolam.html` — Head Loss pada Pipa Kolam: Input yang Dibutuhkan
- `KOL-06-05` → `/artikel/diagram-alir-sistem-kolam.html` — Menyusun Diagram Alir Sistem Kolam
...
- **Tie back to this article:** Keep the explanation specific to “Main Drain, Skimmer, Gutter, dan Balance Tank”.
