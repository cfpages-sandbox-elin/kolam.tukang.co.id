---
article_id: KOL-09-03
title: "Memilih Permukaan Deck Berdasarkan Basah dan Panas"
slug: "memilih-permukaan-deck-kolam"
description: "Select interior finish, coping, deck, joints, drainage, and slip strategy"
status: outline
publication_date: "2026-03-12"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KOL-09
primary_intent: "Compare deck surfaces"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/memilih-permukaan-deck-kolam.html"
...
# Memilih Permukaan Deck Berdasarkan Basah dan Panas

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memilih Permukaan Deck Berdasarkan Basah dan Panas”
- **Reader and situation:** Select interior finish, coping, deck, joints, drainage, and slip strategy
- **Reader outcome:** Select interior finish, coping, deck, joints, drainage, and slip strategy
- **Primary intent:** Compare deck surfaces
...
- **Scope boundary:** Slip/thermal claims require tests
- **Final public route:** `/artikel/memilih-permukaan-deck-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Permukaan Deck Berdasarkan Basah dan Panas**.
...
- `KOL-09-01` → `/artikel/memilih-finish-interior-kolam.html` — Tile, Mosaic, Plaster, atau Membran sebagai Finish Kolam
- `KOL-09-02` → `/artikel/memilih-coping-kolam.html` — Coping Kolam: Bentuk Tepi, Sambungan, dan Pegangan
- `KOL-09-04` → `/artikel/drainase-deck-kolam.html` — Drainase Deck agar Air Kotor Tidak Masuk Kolam
- `KOL-09-05` → `/artikel/joint-coping-deck-shell.html` — Sambungan antara Coping, Deck, dan Shell
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Permukaan Deck Berdasarkan Basah dan Panas”.
