---
article_id: KOL-04-05
title: "Koordinasi Shell Kolam dengan Deck dan Bangunan"
slug: "interface-shell-kolam-dan-deck"
...
date_modified: null
parent_topic: KOL-04
primary_intent: "Plan differential movement"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/interface-shell-kolam-dan-deck.html"
...
# Koordinasi Shell Kolam dengan Deck dan Bangunan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Koordinasi Shell Kolam dengan Deck dan Bangunan”
...
- **Primary intent:** Plan differential movement
...
- **Scope boundary:** Interface concept; engineering required
- **Final public route:** `/artikel/interface-shell-kolam-dan-deck.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Shell Kolam dengan Deck dan Bangunan**.
...
- `KOL-04-03` → `/artikel/jenis-joint-struktur-kolam.html` — Construction Joint, Expansion Joint, dan Movement Joint
- `KOL-04-04` → `/artikel/triase-retak-beton-kolam.html` — Retak Beton Kolam: Triage Sebelum Menentukan Perbaikan
- `KOL-04-06` → `/artikel/dokumen-struktur-kolam.html` — Dokumen Struktur Kolam yang Perlu Disetujui
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Shell Kolam dengan Deck dan Bangunan”.
