---
article_id: KOL-04-03
title: "Construction Joint, Expansion Joint, dan Movement Joint"
slug: "jenis-joint-struktur-kolam"
description: "Understand shell options, loads, joints, cracking, and surrounding structures"
status: outline
publication_date: "2025-11-12"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KOL-04
primary_intent: "Distinguish movement interfaces"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/jenis-joint-struktur-kolam.html"
...
# Construction Joint, Expansion Joint, dan Movement Joint

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Construction Joint, Expansion Joint, dan Movement Joint”
- **Reader and situation:** Understand shell options, loads, joints, cracking, and surrounding structures
- **Reader outcome:** Understand shell options, loads, joints, cracking, and surrounding structures
- **Primary intent:** Distinguish movement interfaces
...
- **Scope boundary:** Detail selection by designer
- **Final public route:** `/artikel/jenis-joint-struktur-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Construction Joint, Expansion Joint, dan Movement Joint**.
...
- `KOL-04-01` → `/artikel/beban-pada-struktur-kolam.html` — Memahami Beban pada Struktur Kolam Renang
- `KOL-04-02` → `/artikel/kolam-tanah-vs-di-atas-gedung.html` — Kolam di Tanah vs Kolam di Atas Struktur Gedung
- `KOL-04-04` → `/artikel/triase-retak-beton-kolam.html` — Retak Beton Kolam: Triage Sebelum Menentukan Perbaikan
- `KOL-04-05` → `/artikel/interface-shell-kolam-dan-deck.html` — Koordinasi Shell Kolam dengan Deck dan Bangunan
...
- **Tie back to this article:** Keep the explanation specific to “Construction Joint, Expansion Joint, dan Movement Joint”.
