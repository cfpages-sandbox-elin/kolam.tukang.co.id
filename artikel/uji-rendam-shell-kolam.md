---
article_id: KOL-05-04
title: "Uji Rendam Shell Kolam Sebelum Finishing"
slug: "uji-rendam-shell-kolam"
description: "Coordinate water barriers, joints, drains, pipes, lights, and leak testing"
status: outline
publication_date: "2025-12-10"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KOL-05
primary_intent: "Plan watertightness verification"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/uji-rendam-shell-kolam.html"
...
# Uji Rendam Shell Kolam Sebelum Finishing

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Uji Rendam Shell Kolam Sebelum Finishing”
- **Reader and situation:** Coordinate water barriers, joints, drains, pipes, lights, and leak testing
- **Reader outcome:** Coordinate water barriers, joints, drains, pipes, lights, and leak testing
- **Primary intent:** Plan watertightness verification
...
- **Scope boundary:** Procedure/criteria require project spec
- **Final public route:** `/artikel/uji-rendam-shell-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Uji Rendam Shell Kolam Sebelum Finishing**.
...
- `KOL-05-02` → `/artikel/waterstop-pada-joint-kolam.html` — Waterstop pada Construction Joint Kolam
- `KOL-05-03` → `/artikel/penetrasi-shell-kolam.html` — Detail Penetrasi Pipa, Inlet, Drain, dan Lampu
- `KOL-05-05` → `/artikel/waterproofing-positif-vs-negatif-kolam.html` — Waterproofing Positif dan Perbaikan dari Sisi Negatif
- `KOL-05-06` → `/artikel/membedakan-sumber-kehilangan-air-kolam.html` — Memisahkan Kebocoran Shell, Pipa, dan Evaporasi
...
- **Tie back to this article:** Keep the explanation specific to “Uji Rendam Shell Kolam Sebelum Finishing”.
