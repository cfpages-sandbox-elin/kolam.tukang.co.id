---
article_id: KOL-10-03
title: "Risiko Suction Entrapment pada Sistem Kolam"
slug: "risiko-suction-entrapment-kolam"
...
date_modified: null
parent_topic: KOL-10
primary_intent: "Understand critical suction hazard"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/risiko-suction-entrapment-kolam.html"
...
# Risiko Suction Entrapment pada Sistem Kolam

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Risiko Suction Entrapment pada Sistem Kolam”
...
- **Primary intent:** Understand critical suction hazard
...
- **Scope boundary:** Requires current standards and specialist design
- **Final public route:** `/artikel/risiko-suction-entrapment-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Risiko Suction Entrapment pada Sistem Kolam**.
...
- `KOL-10-01` → `/artikel/checklist-bahaya-kolam.html` — Checklist Bahaya Kolam untuk Owner dan Pengelola
- `KOL-10-02` → `/artikel/barrier-gate-akses-kolam.html` — Barrier, Gate, dan Kontrol Akses Area Kolam
- `KOL-10-04` → `/artikel/rambu-penanda-kedalaman-kolam.html` — Rambu, Penanda Kedalaman, dan Aturan Penggunaan
...
- **Tie back to this article:** Keep the explanation specific to “Risiko Suction Entrapment pada Sistem Kolam”.
